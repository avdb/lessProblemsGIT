...
// in simulator we redefine to format for lessProblemsGIT Developer console
...
{\
	NSString * exceptionName = [@"org.lessproblemsgit." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.lessproblemsgit";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIlessProblemsGITNativeItemNone = -1, 
	UIlessProblemsGITNativeItemSpinner = -2,
	UIlessProblemsGITNativeItemProgressBar = -3,
	
	UIlessProblemsGITNativeItemSlider = -4,
	UIlessProblemsGITNativeItemSwitch = -5,
	UIlessProblemsGITNativeItemMultiButton = -6,
	UIlessProblemsGITNativeItemSegmented = -7,
	
	UIlessProblemsGITNativeItemTextView = -8,
	UIlessProblemsGITNativeItemTextField = -9,
	UIlessProblemsGITNativeItemSearchBar = -10,
	
	UIlessProblemsGITNativeItemPicker = -11,
	UIlessProblemsGITNativeItemDatePicker = -12,
	
	UIlessProblemsGITNativeItemInfoLight = -13,
	UIlessProblemsGITNativeItemInfoDark = -14,
	
	UIlessProblemsGITNativeItemDisclosure = -15,
	
	UIlessProblemsGITNativeItemContactAdd = -16
};
