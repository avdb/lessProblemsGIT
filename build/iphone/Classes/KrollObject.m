 ...
 * Copyright (c) 2009-2011 by lessProblemsGIT, Inc. All Rights Reserved.
...
//@interface lessProblemsGITObject : NSObject
//@end

@interface lessProblemsGITObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[lessProblemsGITObject class]])
		{
			for (NSString *key in [[(lessProblemsGITObject*)o modules] allKeys])
			{
