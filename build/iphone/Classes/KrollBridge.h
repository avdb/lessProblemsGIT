...
@interface lessProblemsGITObject : KrollCoverageObject {
#else
@interface lessProblemsGITObject : KrollObject {
#endif
@private
...
extern NSString * lessProblemsGIT$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	lessProblemsGITObject *_lessproblemsgit;
	BOOL shutdown;
